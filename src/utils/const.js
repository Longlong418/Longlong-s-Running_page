// const
const MAPBOX_TOKEN =
  'pk.eyJ1IjoibG9uZ2xvbmc0MTgiLCJhIjoiY2xnMGo4ZWY3MTgyZzNmcDZkcGQ1NmF1NiJ9.DlF7hbwYHmrMp3hAk-7ejw';
...
const CHINESE_INFO_MESSAGE = (yearLength, year) => {
  ...
  return `我用 keep 记录自己跑步 ${yearLength} 年了，下面列表展示的是${yearStr}的数据`;
}
